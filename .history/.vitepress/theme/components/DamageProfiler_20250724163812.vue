  ...
  <div class="analysis-suite-card">
    ...
    <div class="tab-content">
      <div> <!-- v-show 也不再需要了 -->
        ...
        <p class="description">
            下图展示了在当前切割配置 (<strong>{{ (isCuttingNerfed ? cuttingPercent / 10 : cuttingPercent).toFixed(2) }}%</strong>) 下，
            随着基础攻击从 <strong>{{ lineChartRange.min }}%</strong> 变化到 <strong>{{ lineChartRange.max }}%</strong>，
