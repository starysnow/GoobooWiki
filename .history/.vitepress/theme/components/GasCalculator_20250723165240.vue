...
th {
    background-color: var(--vp-c-bg); /* 与容器背景稍有区别 */
    font-weight: 600;
    font-size: 0.9em;
...
.result-cell {
    font-weight: bold;
    color: var(--vp-c-brand-dark); /* 使用品牌色 */
    min-width: 140px;
    font-size: 1.1em;
    font-family: 'Courier New', Courier, monospace; /* 使用等宽字体让数字更好看 */
}
</style>