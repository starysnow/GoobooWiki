...
<b>此信息为测试版信息，内容可能与最终发布的正式版有所不同。最终请以正式版上线时的内容为准。</b>

作者发布的消息（翻译）：

今日我很高兴宣布，v1.6版本更新终于进入可玩状态，现已作为测试版本开放！

您可通过此链接访问：https://tendsty.github.io/gooboo-test/

请务必在 test-discussion 和 test-feedback 频道分享您的见解与反馈！与往常一样，请将新版本讨论集中于这些频道，避免影响其他玩家体验。
为确保所有改动符合预期且玩家进度与 v1.5.8 版本大致相当，本次测试期将持续至少 14 天。
期间我将根据玩家反馈进行调整（若准备不足甚至可能延长测试期）。

另请注意：为保持补丁说明简洁易读，此处仅列出最重要变更。您可在设置中调整显示选项！

* 测试版地址：https://tendsty.github.io/gooboo-test/
* 原文链接：https://discord.com/channels/872852814173437982/872860199088689172
![alt text](../../../public/img/update/1.6.0test/作者的信息发布（discord）.png)
...
1. 村庄：供品增加容量变为乘算，购买价格会逐渐变贵；
1. 学校：增加骨尘；
1. 圣遗物：增加圣遗物博物馆和主动技能；
1. 部落：
* 暴击现在是增加伤害倍率，而不是再次乘以伤害；
* 塔的腐败生效了（以前是bug）；
...
* 增加新作物、肥料、升级等；
12. 活动奖励移除宝藏、增加金尘和活动星星；
13. 宝藏：
* 宝藏效果不再是全都随阶数增加翻倍，每种宝藏的效果与阶数的关系独立；
* 宝藏购买价格随全局等级变化；
* 增加宝藏排序功能；
...
注：比如2.66QaV攻击，117%暴击率，345%暴击伤害，伤害为11.83QaV（约445%基础伤害）或21.01QaV（约790%基础伤害）；
...
- <span class="change-tag tag-bugfix"><i class="mdi mdi-bug"></i>Bug修复</span> [#93](https://github.com/Tendsty/gooboo/issues/93) 技能主动冷却时间现在被正确地存储在存档中。
...
- <span class="change-tag tag-clarity"><i class="mdi mdi-lightbulb-on-outline"></i>清晰度</span> [#94](https://github.com/Tendsty/gooboo/issues/94) 主动技能现在会显示它们的名称。
