...
![alt text](/img/update/1.6.0test/作者的信息发布（discord）.png)
...
![alt text](/img/update/1.6.0test/锭增强界面.png)
...
![alt text](/img/update/1.6.0test/锭制作成本.png)
1. 矿石容量和增益大幅下降，可能其他地方有补正
![alt text](/img/update/1.6.0test/矿石增益.png)
1.5.8版本：
![alt text](/img/update/1.6.0test/矿石增益（原版）.png)
1. 增加大量锭相关的锁定升级（需要声望币升级来逐个解锁）
![alt text](/img/update/1.6.0test/锭相关升级.png)
</details>
...
![alt text](/img/update/1.6.0test/绿水晶获取情况.png)
1.5.8版本：
![alt text](/img/update/1.6.0test/绿水晶获取情况（原版）.png)
</details>
...
![alt text](/img/update/1.6.0test/供品.png)
</details>
...
### <img src="/icons/ring.svg" class="header-icon"></img> 圣遗物 (Relics)
...
![alt text](/img/update/1.6.0test/圣遗物.png)
</details>
...
![alt text](/img/update/1.6.0test/部落1新升级1.png)
![alt text](/img/update/1.6.0test/部落1新升级2.png)
![alt text](/img/update/1.6.0test/部落1新升级3.png)
</details>
...
![alt text](/img/update/1.6.0test/熔火盾.png)
...
### <img src="/icons/cards.svg" class="header-icon"></img> 卡牌 (Cards)
...
示例图：
![alt text](/img/update/1.6.0test/卡组1.png)
</details>



### <img src="/icons/medal.svg" class="header-icon"></img> 将军 (Generals)
...
![alt text](/img/update/1.6.0test/特殊作物1.png)
</details>
<details>
<summary>巨型作物</summary>
现在每种作物都可以种植它的巨型版，效果和巨人基因差不多

![alt text](/img/update/1.6.0test/巨型作物.png)
</details>

### <img src="/icons/calendar.svg" class="header-icon"></img> 活动 (Event)
