export default {
  ...
  "modules/event/relic": {
    ...
    eightBall: {
      ...
      feature: ["event", "mining"],
      color: "darker-grey",
      effect: [{ name: "miningDamage", type: "mult", value: 1.08 }],
    }, // Wheel of fortune
    youngPig: {
  ...
  "modules/event/snowdown/item": {
    ...
    appleJuice: {
      type: "tank",
      icon: "mdi-cup", // Heal the player for 50% max health. Consumes player action. Limit of 1
    },
    hotWater: {
      type: "tank",
      icon: "mdi-needle",
      max: 1, // Revive the player once with 25% max health
    },
    dumbbell: {
      type: "tank",
      icon: "mdi-dumbbell",
    ...
    pebbles: {
      ...
      max: 1, // Crits stun the target for 1 turn
    }, // Filler items
    sunShield: { icon: "mdi-shield-sun", effect: [{ name: "snowdownDefense", type: "base", value: (lvl) => lvl * 2 }] },
    moonShield: {
  ...
  "modules/event/summerFestival/building": {
    ...
    huntingArea: {
      ...
      price(lvl) {
        return {
          event_log: Math.pow(25, lvl) * buildNum(6.6, "M"),
          event_shell: Math.pow(25, lvl) * buildNum(2.4, "M"),
        };
      },
    ...
    mine: {
      ...
      price(lvl) {
        return {
          event_log: Math.pow(25, lvl) * buildNum(30, "M"),
          event_solidPlate: Math.pow(8, lvl) * buildNum(37.5, "K"),
          event_sandstone: Math.pow(8, lvl) * 3300,
        };
      },
    ...
    grill: {
      ...
      price(lvl) {
        return {
          event_coconut: Math.pow(25, lvl) * buildNum(100, "M"),
      ...
      action: {
        cookMeat: {
          icon: "mdi-food-steak",
          input: { event_rawMeat: 1, event_coal: 1 },
          output: { event_cookedMeat: 1 },
          minLevel: 1,
          speed: (lvl) => Math.pow(2, lvl) * 0.01,
        },
        cookFish: {
    ...
    shellOpener: {
      ...
      price(lvl) {
        return {
          event_coconut: Math.pow(40, lvl) * buildNum(8.5, "B"),
      ...
      action: {
        openShell: {
          icon: "mdi-filter",
          input: { event_shell: buildNum(20, "K") },
    ...
    fishingNet: {
      ...
      price(lvl) {
        return {
          event_solidPlate: Math.pow(9, lvl) * buildNum(350, "K"),
          event_sandstone: Math.pow(7, lvl) * buildNum(405, "K"),
        };
      },
  ...
  "modules/event/summerFestival/prize": {
    theme_waves: {
      type: "theme",
      item: "waves",
      pool: { summerFestival: { price: { event_summerFestivalToken: 240 } } },
    },
    relic_tropicalTent: {
      type: "relic",
      item: "tropicalTent",
    ...
    cardPack_charmingShip: {
      type: "cardPack",
      item: "charmingShip",
      pool: { summerFestival: { price: { event_summerFestivalToken: 30 } } },
    },
    farm_tropicalWater: {
      type: "consumable",
  ...
  "modules/event/summerFestival/upgrade": {
    ...
    doubleTime: {
      ...
      effect: [{ name: "summerFestivalBuildQueueSpeed", type: "mult", value: (lvl) => lvl + 1 }],
    },
    tropicalBlessing: {
      type: "summerFestival",
      cap: 8,
  ...
  "modules/event/weatherChaos/prize": {
    theme_rain: { type: "theme", item: "rain", pool: { weatherChaos: { price: { event_weatherChaosToken: 260 } } } },
    relic_trashCan: {
      type: "relic",
      item: "trashCan",
  ...
  "modules/event/weatherChaos/weather": {
    ...
    hail: { icon: "mdi-weather-hail", next: ["pouring", "rainy", "snowy", "snowstorm"], rain: true, snow: true },
    hazy: { icon: "mdi-weather-hazy", next: ["sunny", "fog", "partlyCloudy"], sun: true },
    lightning: { icon: "mdi-weather-lightning", next: ["cloudy", "thunderstorm", "partlyLightning"], thunder: true },
    thunderstorm: {
    ...
    snowstorm: { icon: "mdi-weather-snowy-heavy", next: ["hail", "snowy"], snow: true },
    snowyRainy: { icon: "mdi-weather-snowy-rainy", next: ["rainy", "snowy"], rain: true },
    windy: { icon: "mdi-weather-windy", next: ["partlyWindy", "storm"], wind: true },
  ...
  "modules/farm/fertilizer": {
    ...
    analyzing: { type: "all", color: "blue", price: { gem_sapphire: 5 }, effect: { farmExperience: 1.35 } },
    superJuicy: {
      type: "berry",
      color: "orange-red",
  ...
  "modules/farm/upgrade": {
    ...
    goldenTools: {
      ...
      effect: [{ name: "farmCropGain", type: "mult", value: (lvl) => lvl * 0.1 + 1 }],
    },
    butterflyWings: {
      cap: 6,
      requirementBase,
  ...
  "modules/gallery/upgrade": {
    ...
    greenConversion: {
      ...
      effect: [{ name: "galleryGreenConversion", type: "mult", value: (lvl) => Math.pow(2, lvl) }],
    },
    redRage: {
      cap: 40,
      requirement() {
    ...
    amberConversion: {
      ...
      effect: [{ name: "galleryAmberConversion", type: "mult", value: (lvl) => Math.pow(2, lvl) }],
    },
    lightGreenPower: {
      cap: 15,
      capMult: true,
    ...
    lightBluePower: {
      ...
      effect: [{ name: "currencyGalleryTealGain", type: "mult", value: (lvl) => splicedPowLinear(1.25, 0.1, 15, lvl) }],
    },
    tealLuck: {
      cap: 40,
      requirement() {
  ...
  "modules/horde/equipment": {
    ...
    snowflake: {
      ...
      masteryBoost: 0.25,
      active() {
        return [{ type: "removeAttack", value: 0.4 }];
      },
      activeType: "combat",
      cooldown: () => 1200,
      icon: "mdi-snowflake",
    ...
    wizardHat: {
      ...
      active() {
        return [{ type: "damageMagic", value: 25, int: 0.4 }];
      },
      activeType: "combat",
      cooldown: () => 125,
      icon: "mdi-wizard-hat",
  ...
  "modules/horde/fighterClass/archer": {
    ...
    skills: {
      ...
      reduceCooldownOnCrit: {
        ...
        max: 1,
        cost: 50,
        effect: [{ name: "hordeRestoreCooldownOnCrit", type: "tag", value: (lvl) => [lvl] }],
      },
      haste: {
        type: "stat",
        max: 15,
      ...
      sharpMind: {
        ...
        active(lvl) {
          return [{ type: "permanentStat", stat: "hordeCritMult_base", value: lvl * 0.02 + 0.02 }];
        },
        activeType: "utility",
      },
      critChance_3: {
  ...
  "modules/horde/upgrade": {
    ...
    dodgingGuide: {
      ...
      effect: [{ name: "hordeHealth", type: "mult", value: (lvl) => Math.pow(1.2, lvl) }],
    },
    survivalGuide: {
      cap: 25,
      capMult: true,
  ...
  "modules/horde/upgrade2": {
    ...
    harvest: {
      ...
      effect: [{ name: "currencyHordeBloodGain", type: "mult", value: (lvl) => Math.pow(1.11, lvl) }],
    },
    protectiveShell: {
      subfeature: 1,
      cap: 20,
    ...
    chaosCrate: {
      ...
      effect: [
        { name: "hordeAttack", type: "mult", value: (lvl) => Math.pow(1.35, lvl) },
        {
          ...
          type: "mult",
          value: (lvl) => (lvl >= 1 ? Math.floor((lvl + 4) / 5) * 0.5 + 1 : null),
        },
        {
          name: "hordeHeirloomAmount",
          type: "base",
          value: (lvl) => (lvl >= 2 ? Math.floor((lvl + 3) / 5) * 5 : null),
        },
        {
  ...
  "modules/horde": {
      ...
      while (secondsLeft > 0) {
        ...
        if (((simulation.dead >= 2 && simulation.killed >= 100) || simulation.dead >= 10) && !simulation.complete) {
            ...
            if (!isStunned || usedAttack) {
              ...
              if (usedAttack && item) {
                ...
                const baseDamage =
                  ...
                  Math.pow(playerStats.critMult, crits);
          ...
          if (!isEnemyStunned || usedAttack !== null) {
            ...
            if (usedAttack === null) {
              ...
              active.effect(enemyStats.sigil[usedAttack], store.state.horde.bossFight).forEach((elem) => {
                if (elem.type === "heal") {
                  ...
                  store.commit("horde/updatePlayerKey", {
                    key: "stun",
                    value: store.state.horde.player.stun + elem.value,
                  });
                } else if (elem.type === "silence") {
                  store.commit("horde/updatePlayerKey", {
                    key: "silence",
            ...
            playerHealth = Math.max(0, playerHealth - enemyDamage); // Only hit shield and count hits if damage was dealt
    ...
    consumable: { manaPotion: { icon: "mdi-flask-round-bottom", color: "dark-blue", price: { gem_sapphire: 35 } } },
    init() {
  ...
  "modules/mining/achievement": {
    ...
    dwellerCapHit: {
      value: () => store.state.stat.mining_dwellerCapHit.total,
      secret: true,
      display: "boolean",
      cap: 1,
      milestones: () => 1,
    ...
    craftingLuck: {
      value: () => store.state.stat.mining_craftingLuck.total,
      default: 1,
      secret: true,
      cap: 1,
  ...
  "modules/mining/relic": {
    ...
    coalBrick: {
      icon: "mdi-wall",
      color: "dark-grey",
      effect: [{ name: "mining_furnace", type: "keepUpgrade", value: true }],
    },
    washingMachine: {
  ...
  "modules/mining/upgrade": {
    ...
    warehouse: {
      ...
      price(lvl) {
        return {
          ...
          mining_barAluminium: lvl * 5 + 40,
          mining_barBronze: lvl * 4 + 4,
        };
      },
      effect: [
    ...
    titaniumForge: {
      ...
      price(lvl) {
        return {
          mining_barAluminium: Math.pow(2, lvl) * 500,
          mining_barBronze: lvl * 250 + 500,
    ...
    iridiumTreetap: {
      ...
      price(lvl) {
        return {
          mining_deeprock: Math.pow(lvl + 1, 2) * buildNum(500, "M"),
          mining_barIridium: Math.round(Math.pow(1.3, lvl) * (lvl + 2)),
        };
      },
      effect: [
  ...
  "modules/mining/upgradePremium": {
    ...
    fasterSmeltery: {
      ...
      effect: [{ name: "miningSmelterySpeed", type: "mult", value: (lvl) => lvl + 1 }],
    },
    moreResin: {
      type: "premium",
      requirement() {
    ...
    moreHelium: {
      ...
      effect: [{ name: "currencyMiningHeliumGain", type: "base", value: (lvl) => lvl * 0.004 }],
    },
    moreSmoke: {
      type: "premium",
      requirement() {
  ...
  "modules/mining/upgradePrestige": {
    ...
    crystalTinStorage: {
      ...
      effect: [{ name: "currencyMiningOreTinCap", type: "mult", value: (lvl) => lvl * 0.25 + 1 }],
    },
    crystalIronStorage: {
      type: "prestige",
      cap: 16,
  ...
  "modules/mining": {
    ...
    tick: function (seconds) {
      ...
      if (store.state.mining.beaconCooldown > 0) {
        store.commit("mining/updateKey", {
          key: "beaconCooldown",
          value: Math.max(store.state.mining.beaconCooldown - seconds, 0),
        });
      } // Smeltery
    ...
    currency: {
      ...
      oreAluminium: {
        ...
        icon: "mdi-chart-bubble",
        gainMult: {},
        capMult: { baseValue: 12, round: true },
        gainTimerFunction() {
          const hitsNeeded = store.getters["mining/hitsNeeded"];
          const oreGain = store.getters["mining/currentOre"];
          return hitsNeeded === Infinity || !oreGain.oreAluminium
            ? null
  ...
  "modules/patchnote/v1_3_0": {
    ...
    content: {
      ...
      horde: [
        ...
        { unlock: "hordePrestige", type: "new", text: "129" },
        { type: "new", text: "130" },
        { type: "new", text: "131" },
        { unlock: "hordeHeirlooms", type: "balance", text: "132" },
        { unlock: "hordeHeirlooms", type: "change", text: "136" },
  ...
  "modules/patchnote/v1_5_0": {
    ...
    content: {
      ...
      village_1: [
        ...
        { type: "new", text: "addedVillageRecipe", params: [30] },
        { type: "new", text: "addedUpgrade", params: [12] },
        { type: "new", text: "addedPrestigeUpgrade", params: [10] },
      ],
      horde_1: [
        { type: "new", text: "addedSubfeature" },
  ...
  "modules/patchnote/v1_5_4": {
    ...
    content: {
      ...
      event: [
        ...
        { unlock: "snowdownEvent", type: "balance", text: "421", balance: "buff", before: "140", after: "55" },
        { unlock: "snowdownEvent", type: "remove", text: "422" },
        { unlock: "snowdownEvent", type: "change", text: "423" },
        { unlock: "snowdownEvent", type: "new", text: "424" },
  ...
  "modules/school/bookFarm": {
    ...
    bookScarecrow: {
      ...
      effect: [{ name: "upgradeFarmScarecrowCap", type: "base", value: (lvl) => lvl }],
    },
    bookShed: {
      type: "book",
  ...
  "modules/school/bookHorde": {
    ...
    bookSurvivalGuide: {
      ...
      effect: [{ name: "upgradeHordeSurvivalGuideCap", type: "base", value: (lvl) => lvl }],
    },
    bookCarving: {
      type: "book",
  ...
  "modules/school": {
    ...
    tick(minutes, oldTime, newTime) {
      store.dispatch("currency/gain", {
        ...
        name: "book",
        amount:
          (store.getters["mult/get"]("currencySchoolBookGain", store.getters["school/subjectsBookGain"]) * minutes) /
          MINUTES_PER_HOUR,
      });
  ...
  "modules/village/achievement": {
    ...
    advancedResources: {
      value: () => Math.max(store.state.stat.village_hardwoodMax.total, store.state.stat.village_gemMax.total),
      milestones: (lvl) => Math.pow(6, lvl) * buildNum(10, "K"),
      relic: { 3: "supervisor" },
    },
  ...
  "modules/village/building": {
    ...
    campfire: {
      ...
      effect: [{ name: "villageBuildings1", type: "unlock", value: (lvl) => lvl >= 1 }],
    }, // Tier 1 buildings
    hut: {
      cap: 25,
      capMult: true,
    ...
    storage: {
      ...
      effect: [
        ...
        { name: "currencyVillageStoneCap", type: "mult", value: (lvl) => splicedPowLinear(1.2, 0.1, 20, lvl) },
        {
          ...
          type: "mult",
          value: (lvl) => (lvl > 5 ? splicedPowLinear(1.2, 0.1, 15, lvl - 5) : null),
        },
      ],
    },
    forge: {
    ...
    townHall: {
      ...
      price() {
        return {
          village_wood: buildNum(12.8, "K"),
          village_stone: buildNum(10.5, "K"),
          village_metal: 3150,
          village_water: 2900,
        };
      },
      effect: [{ name: "villageBuildings3", type: "unlock", value: (lvl) => lvl >= 1 }],
    }, // Tier 3 buildings
    house: {
      cap: 25,
      capMult: true,
    ...
    shed: {
      ...
      price(lvl) {
        return {
          village_wood: Math.pow(1.8, lvl) * buildNum(14.5, "K"),
          village_stone: Math.pow(2.05, lvl) * 9000,
          village_metal: Math.pow(1.7, lvl) * 5200,
        };
      },
      effect: [
    ...
    temple: {
      ...
      effect: [{ name: "currencyVillageFaithCap", type: "mult", value: (lvl) => Math.pow(1.2, lvl) }],
    },
    obelisk: {
      cap: 0,
      capMult: true,
