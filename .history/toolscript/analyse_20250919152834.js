...
// 【重要】请修改为你的实际文件路径
// 包含升级和物品数据的源JS文件
const SOURCE_FILE_PATH = path.resolve(__dirname, '..', 'js', 'modules', 'horde', 'equipment.js'); // 示例路径，请修改
// 最终生成的Markdown文件
const OUTPUT_FILE_PATH = path.resolve(__dirname, '..', 'public',  'wiki_output.md');
// 你的翻译词典
