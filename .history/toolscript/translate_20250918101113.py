...
# 1. --- 配置区 ---
# 输入文件
AI_OUTPUT_FILE = "source_data/gemini_output/output.json"
LANG_ZH_FILE = "source_data/lang/zh_snowdown_item.json" # 假设你已将zh.js的item部分转为JSON

# 输出文件
MARKDOWN_OUTPUT_FILE = "wiki_tables/snowdown_items.md"
