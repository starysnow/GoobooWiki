...
# 在这里修改你的文件路径
# 示例:
# JS_FILE_PATH = 'path/to/your/js_modules/mining/enhancement.js'
# ZH_MAP_PATH = 'path/to/your/public/zh_map.json'
# OUTPUT_DIR = 'path/to/your/wiki_output'
# OUTPUT_FILENAME = 'mining_enhancements.md'
