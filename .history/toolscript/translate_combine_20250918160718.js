...
const SOURCE_FILE_PATH = path.resolve(__dirname, 'combine.js');
const OUTPUT_FILE_PATH = path.resolve(__dirname, 'combine_zh.js'); // 翻译后的输出文件
const TRANSLATION_MAP_PATH = path.resolve(__dirname, 'zh_map.json');
