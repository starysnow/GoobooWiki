...
| --- | ---- | ----- | ------ |
| 大圆 | shape | ${ 圆形: {(lvl  \cdot  0.01 + 1.35)}^{lvl}  \cdot  100 }$ | 形状增益*｛${(1.3)}^{lvl}$｝ |
| 画得很好的圆 | shape | ${ 圆形: {(lvl  \cdot  0.05 + 2.25)}^{lvl}  \cdot  5000 }$ | 红色油漆增益*｛$lvl  \cdot  0.02 + 1$｝ |
| 大矩形 | shape | ${ 矩形: {(lvl  \cdot  0.1 + 1.75)}^{lvl}  \cdot  1000 }$ | 动机容量+｛$lvl  \cdot  5$｝ |
| 画得很好的矩形 | shape | ${ 矩形: {(lvl  \cdot  0.05 + 2.25)}^{lvl}  \cdot  6500 }$ | 转换器容量+｛$lvl  \cdot  40$｝ |
| 创意 | shape | $fallbackArray([{ 三角形: 10K, 圆形: 4000 }, { 三角形: 100K, 矩形: 40K }, { 三角形: 10M, 星形: 4M }, { 三角形: 10B, 椭圆形: 3B, 心形: 3B }, { 三角形: 100T, 正方形: 30Sx, 八边形: 30T }, { 三角形: 10Qi, 五边形: 300Qa, 六边形: 300Qa }], { 三角形: {(10)}^{getSequence(1, lvl})  \cdot  10K }, lvl)$ | 炸弹形状｛$lvl >= 1$｝; dice形状｛$lvl >= 2$｝; accelerator形状｛$lvl >= 3$｝; sparkles形状｛$lvl >= 4$｝; hourglass形状｛$lvl >= 5$｝; chest形状｛$lvl >= 6$｝; 动机容量+｛$lvl >= 7 ? (lvl - 6)  \cdot  10 : null$｝ |
...
| 大心形 | shape | ${ 心形: {(lvl + 8)}^{lvl}  \cdot  2M }$ | 形状增益*｛${(2)}^{lvl}$｝; 动机容量+｛$lvl  \cdot  10$｝ |
