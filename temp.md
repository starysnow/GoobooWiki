---
title: Gooboo v1.5.8 更新日志
description: Gooboo v1.5.8 版本详细更新日志，包含游戏、采矿、部落、农场等多个模块的大量新增内容和平衡性调整。
---
...
本次 v1.5.8 更新是一次**大规模**的全方位更新，体量巨大，几乎触及了游戏的所有核心系统。对于玩家而言，这次更新带来了机遇与挑战并存的重大变化。
...
### <i class="mdi mdi-gamepad-variant"></i> 游戏 (Game)
...
- <span class="change-tag tag-appearance"><i class="mdi mdi-palette"></i>外观</span> [#59](https://github.com/starysnow/Gooboo/issues/59) 增加了选择数字格式的选项。
...
- <span class="change-tag tag-quality_of_life"><i class="mdi mdi-heart-pulse"></i>生活质量</span> [#58](https://github.com/starysnow/Gooboo/issues/58) 提升了自动进阶的最大值。
...
- <span class="change-tag tag-change"><i class="mdi mdi-sync"></i>变更</span> 祭品现在随着你购买而变得更贵。
- <span class="change-tag tag-new"><i class="mdi mdi-plus"></i>新增</span> 祭品现在也会以乘法方式增加资源容量。
...
### <i class="mdi mdi-star-box-outline"></i> 圣遗物 (Relics)
...
- <span class="change-tag tag-balancing"><i class="mdi mdi-scale-balance"></i>平衡</span> 师团护盾在击败敌人后回复：<span class="change-detail"><span class="old-value">100%</span><span class="arrow">»</span><span class="new-value">10%</span></span>
- <span class="change-tag tag-balancing"><i class="mdi mdi-scale-balance"></i>平衡</span> 改变了装备精通4的效果：主动技能现在是1.5倍强，而不是冷却时间减半。
...
- <span class="change-tag tag-balancing"><i class="mdi mdi-scale-balance"></i>平衡</span> 主动技能无法将师团护盾增加到超过给定的最大值。

### <i class="mdi mdi-cards-playing-outline"></i> 卡牌 (Cards)
...
### <i class="mdi mdi-file-document-outline"></i> 概览 (Generals)
...
### <i class="mdi mdi-party-popper"></i> 活动 (Event)
...
- <span class="change-tag tag-new"><i class="mdi mdi-plus"></i>新增</span> 新增了腐化血肉增益效果。
...
### <i class="mdi mdi-snowflake"></i> 低温实验室 (Cryo lab)
- <span class="change-tag tag-clarity"><i class="mdi mdi-lightbulb-on-outline"></i>清晰度</span> 现在可以查看不活跃的子功能。
- <span class="change-tag tag-balancing"><i class="mdi mdi-scale-balance"></i>平衡</span> 每级低温实验室的声望增益：<span class="change-detail"><span class="old-value">+0.1x</span><span class="arrow">»</span><span class="new-value">x1.15</span></span>
...
- <span class="change-tag tag-balancing"><i class="mdi mdi-scale-balance"></i>平衡</span> 每点卡牌力量的金钱增益：<span class="change-detail"><span class="old-value">x1.05</span><span class="arrow">»</span><span class="new-value">x1.02</span></span>
...
### <i class="mdi mdi-earth-box"></i> 气体巨人 (Gas giant)
